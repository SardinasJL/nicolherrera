    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-primary shadow-sm">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img src="{{url("imagenes/logo.png")}}" width="30" height="30"
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{Request::is("actividades*")?'active':''}}"
                           href="{{route("actividades.index")}}">Actividades</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{Request::is("tutores*")?'active':''}}" href="{{route("tutores.index")}}">
                            Tutores</a>
                    </li>
                    <li class="nav-item">
