    ...
    <div class="container col-md-10">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-8">
                        Asignar padre/madre/tutor al estudiante:
            ...
            <div class="card-body">
                ...
                <form action="{{route("estudiantes.tutores.store", [$estudiante])}}" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="tutores_id" class="form-label">Padre/madre/tutor</label>
                        <select name="tutores_id" id="tutores_id" class="form-select">
                            @foreach($tutores as $tutor)
                                <option value="{{$tutor->id}}" {{$tutor->id==old("tutores_id")?"selected":""}}>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="relaciones_id" id="relaciones_id" class="form-select">
                            @foreach($relaciones as $relacion)
                                <option value="{{$relacion->id}}" {{$relacion->id==old("relacion")?"selected":""}}>
